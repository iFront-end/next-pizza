      ...
      <SliderPrimitive.Root
        ...
        { localValues.map((value, index) => (
          <Fragment key={ index }>
            ...
            <SliderPrimitive.Thumb className="block cursor-pointer h-4 w-4 rounded-full border border-primary/50 bg-white shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
          </Fragment>
        ))}
      </SliderPrimitive.Root>
    );
