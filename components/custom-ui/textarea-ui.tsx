...
export const TextareaUi: FC<Props> = ({ label, name, required, cleanable, placeholder, className }): ReactElement => {
  ...
  return (
    <div className={ cn('relative', className) }>
      ...
      <div className='relative flex items-center'>
        <Textarea id={ name } placeholder={ placeholder } {...register(name)}  className='resize-none' rows={ 5 } />
