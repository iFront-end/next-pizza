...
const up = async () => {
  ...
  const pizza4 = await prisma.product.create({
    data: {
      ...
      imageUrl: 'https://media.dodostatic.net/image/r:584x584/11EE7D61095E56E6BBC9D410F89DF983.jpg',
      categoryId: 1,
      ingredients: {
  ...
  const pizza5 = await prisma.product.create({
    data: {
      ...
      imageUrl: 'https://media.dodostatic.net/image/r:584x584/11EE7D6169F149548AF85880D7F1E053.jpg',
      categoryId: 1,
      ingredients: {
